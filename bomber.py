...
def bann_text():
    ...
    logo =  """
ooooo      ooo             oooooooooo.    .oooooo.   ooo        ooooo oooooooooo.  
`888b.     `8'             `888'   `Y8b  d8P'  `Y8b  `88.       .888' `888'   `Y8b 
 8 `88b.    8               888     888 888      888  888b     d'888   888     888 
 8   `88b.  8               888oooo888' 888      888  8 Y88. .P  888   888oooo888' 
 8     `88b.8               888    `88b 888      888  8  `888'   888   888    `88b 
 8       `888               888    .88P `88b    d88'  8    Y     888   888    .88P 
o8o        `8  ooooooooooo o888bood8P'   `Y8bood8P'  o8o        o888o o888bood8P'  
...
def do_zip_update():
    ...
    if DEBUG_MODE:
        ...
        zip_url = "https://github.com/N17R0-HACKERS/N_BOMB/archive/dev.zip"

        dir_name = "N_BOMB-dev"

    else:

        zip_url = "https://github.com/N17R0-HACKERS/N_BOMB/archive/master.zip"

        dir_name = "N_BOMB-master"
    ...
    if success:
        ...
        mesgdcrt.SuccessMessage("N_BOMB was updated to the latest version")
        ...
        mesgdcrt.FailureMessage("Unable to update N_BOMB.")

        mesgdcrt.WarningMessage(

            "Grab The Latest one From https://github.com/N17R0-HACKERS/N_BOMB.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            ...
            "git pull https://github.com/N17R0-HACKERS/N_BOMB.git HEAD")
...
def check_for_updates():
    ...
    fver = requests.get(
        ...
        "https://raw.githubusercontent.com/N17R0-HACKERS/N_BOMB/master/.version"
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("N_BOMB is up-to-date")

        mesgdcrt.GeneralMessage("Starting N_BOMB")
...
def notifyen():
    ...
    try:
        ...
        if DEBUG_MODE:
            ...
            url = "https://github.com/N17R0HACKERS/N_BOMB/raw/dev/.notify"

        else:

            url = "https://github.com/N17R0HACKERS/N_BOMB/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("N_BOMB was created by N17R0-HACKERS (WHOAMI)")
...
if sys.version_info[0] != 3:
    ...
    mesgdcrt.FailureMessage("N_BOMB will work only in Python v3")
...
description = """N_BOMB - Your Friendly Spammer Application

N_BOMB can be used for many purposes which incudes -
...
N_BOMB is not intented for malicious uses.
...
parser.add_argument("-sms", "--sms", action="store_true",
                    ...
                    help="start N_BOMB with SMS Bomb mode")

parser.add_argument("-call", "--call", action="store_true",

                    help="start N_BOMB with CALL Bomb mode")

parser.add_argument("-mail", "--mail", action="store_true",

                    help="start N_BOMB with MAIL Bomb mode")
...
parser.add_argument("-c", "--contributors", action="store_true",
                    ...
                    help="show current N_BOMB contributors")

parser.add_argument("-v", "--version", action="store_true",

                    help="show current N_BOMB version")
